      ...
      @endif
        ...
        <div class="panel panel-primary filterable">
            <div class="panel-heading" style="background-color: Black;">
                <h3 class="panel-title">All Blog Posts</h3>
            ...
            <table class="table">
                ...
                <tbody>
                  ...
                  @foreach($blogs->all() as $blog)
                    ...
                    <tr>
                        <td><h3>{{$blog->id}}</h3></td>
                        <td><h3>{{$blog->author}}</h3></td>
                        <td><h3>{{$blog->title}}</h3></td>
                        <td>{{$blog->description}}</td>
                        <td><a href='{{url("/readpost/{$blog->id}")}}' class="label label-primary">Read More</a> |
            
                            <a href='{{url("/deletepost/{$blog->id}")}}' class="label label-danger">Delete Post</a> |
                      </td>
                    </tr>
                  @endforeach
