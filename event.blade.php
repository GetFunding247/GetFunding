...
<!-- Creating New Event(***Note: csrf_field token is used to prevent csrf attacks) -->
<div class="container">
<div class="col-md-5">
    <div class="form-area">  
        ...
        <br style="clear:both">
          ...
          @if(count($errors)>0)
                  ...
                  @endif
                    <h4 style="margin-bottom: 25px; text-align: center;">Add Event Information</h4>
            <div class="form-group">
            <input type="text" class="form-control" id="title" name="title" placeholder="Title" required>
          </div>
          
                    <div class="form-group">
                    <textarea class="form-control" name="description" type="textarea" id="description" placeholder="Description" maxlength="1000" rows="7"></textarea>                   
                    </div>
